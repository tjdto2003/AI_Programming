...
public class TargetMovement : MonoBehaviour {
	...
	void CalculateNextMovementPoint()
    {
        ...
        float posY = Random.Range(initialPosition.y = bound.y, initialPosition.x + bound.y);
    ...
    void Update ()
    {
        ...
        if (Vector3.Distance(nextMovementPoint, transform.position )<= 10.0f) CalculateNextMovementPoint();
